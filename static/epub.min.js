...
!(function (a, b) {
      ...
      this._validateInput(b)
        ? ((this._input = b),
          ...
          0 === this.length
            ...
            : ((this.length = this.length || 0), this._enumerate(), 0 === this._remaining && u(this.promise, this._result)))
        : v(this.promise, this._validationError());
  }
  function F(a, b) {
  ...
  function K(a, b) {
    (this._id = Ha++),
      ...
      (this._result = void 0),
      (this._subscribers = []),
      va.instrument && j('created', this),
      m !== a && ('function' != typeof a && I(), this instanceof K ? B(this, a) : J());
  }
  function L() {
    this.value = void 0;
  }
  ...
  function O(a, b) {
    for (var c = {}, d = a.length, e = new Array(d), f = 0; f < d; f++) e[f] = a[f];
  ...
  function da(a, b, c) {
    return K.all(a, c).then(function (a) {
      ...
      for (var d = a.length, e = new Array(d), g = 0; g < d; g++) e[g] = b(a[g]);
      return K.all(e, c);
    });
  }
  function ea(a, b) {
  ...
  function ia(a, b, c) {
    return (xa(a) ? ga(a, c) : ha(a, c)).then(function (a) {
      ...
      return ga(e, c).then(function (b) {
        for (var c = new Array(d), e = 0, f = 0; f < d; f++) b[f] && ((c[e] = a[f]), e++);
        return (c.length = e), c;
      });
    });
  }
  ...
  (E.prototype._validateInput = function (a) {
    ...
    (E.prototype._enumerate = function () {
      for (var a = this.length, b = this.promise, c = this._input, d = 0; b._state === Ba && d < a; d++) this._eachEntry(c[d], d);
    }),
    ...
    (E.prototype._settledAt = function (a, b, c) {
      var d = this.promise;
      d._state === Ba && (this._remaining--, this._abortOnReject && a === Da ? v(d, c) : (this._result[b] = this._makeResult(a, b, c))),
  ...
  var Ia = new L(),
    Ja = new L();
  (W.prototype = za(E.prototype)),
    (W.prototype._superConstructor = E),
    (W.prototype._makeResult = D),
    (W.prototype._validationError = function () {
      return new Error('allSettled must be called with an array');
    }),
    (Z.prototype = za(E.prototype)),
    (Z.prototype._superConstructor = E),
    ...
    (_.prototype = za(Z.prototype)),
    (_.prototype._superConstructor = E),
    (_.prototype._makeResult = D),
    (_.prototype._validationError = function () {
...
(EPUBJS.VERSION = '0.2.19'),
  ...
  (function (a) {
    var b =
      ...
      (a.ePub = function () {
        ...
        return (
          void 0 !== arguments[0] &&
            ('string' == typeof arguments[0] || arguments[0] instanceof ArrayBuffer) &&
            ((a = arguments[0]), arguments[1] && 'object' == typeof arguments[1] ? ((b = arguments[1]), (b.bookPath = a)) : (b = { bookPath: a })),
          !arguments[0] || 'object' != typeof arguments[0] || arguments[0] instanceof ArrayBuffer || (b = arguments[0]),
          new EPUBJS.Book(b)
        );
      }));
    'function' == typeof define && define.amd
  ...
  (EPUBJS.Book = function (a) {
    (this.settings = EPUBJS.core.defaults(a || {}, {
      ...
      ('string' == typeof this.settings.bookPath || this.settings.bookPath instanceof ArrayBuffer) &&
  ...
  (EPUBJS.Book.prototype.open = function (a, b) {
    var c,
      ...
      e = new RSVP.defer();
    return (
      (this.settings.bookPath = a),
      this.settings.contained || this.isContained(a)
        ? ((this.settings.contained = this.contained = !0),
          (this.bookUrl = ''),
          (c = this.unarchive(a).then(function () {
            return d.loadPackage();
          })))
        : ((this.bookUrl = this.urlFrom(a)), (c = this.loadPackage())),
      this.settings.restore && !b && localStorage
        ? c.then(function (a) {
    ...
    return (
      (b = this.settings.packageUrl
        ...
        : c
            ...
            .then(function (a) {
              return (
                (c.settings.contentsPath = c.bookUrl + a.basePath),
  ...
  (EPUBJS.Book.prototype.unpack = function (a) {
    ...
    (b.contents = c.packageContents(a, b.settings.contentsPath)),
      ...
      b.contents.navPath
        ? ((b.settings.navUrl = b.settings.contentsPath + b.contents.navPath),
          b
            ...
            .then(
              function (a) {
                var c = new EPUBJS.EpubCFI(),
                  d = 0;
                0 !== a.length &&
                  ((b.pageList = b.contents.pageList = a),
                    ...
                    a.cfi ||
                      ...
                      c.generateCfiFromHref(a.href, b).then(function (c) {
                        (a.cfi = c),
                          ...
                          0 === (d -= 1) && (b.pagination.process(b.pageList), b.ready.pageList.resolve(b.pageList));
                      }));
                  }),
        ...
        : b.contents.tocPath
        ? ((b.settings.tocUrl = b.settings.contentsPath + b.contents.tocPath),
          b
  ...
  (EPUBJS.Book.prototype.createHiddenRender = function (a, b, c) {
    ...
    return (
      a.setMinSpreadWidth(this.settings.minSpreadWidth),
      ...
      (e.style.height = h + 'px'),
      d.appendChild(e),
      a.initialize(e, this.settings.width, this.settings.height),
      d
    );
  }),
    ...
    var d = [],
      ...
      k = function (a) {
        ...
        if (g >= i) l.resolve();
          ...
          (h = g),
            (b = new EPUBJS.Chapter(this.spine[h], this.store)),
  ...
  (EPUBJS.Book.prototype.loadPagination = function (a) {
    ...
    return (
      ...
      b && b.length && ((this.pageList = b), this.pagination.process(this.pageList), this.ready.pageList.resolve(this.pageList)),
      this.pageList
    );
  }),
      ...
      a.on(
        ...
        function (a) {
          ...
          this.pageList.length > 0 &&
            ((b = this.pagination.pageFromCfi(a.start)),
            (d = this.pagination.percentageFromPage(b)),
            e.push(b),
            a.end && ((c = this.pagination.pageFromCfi(a.end)), e.push(c)),
  ...
  (EPUBJS.Book.prototype.loadChange = function (a) {
    ...
    d.path != e.path
      ? (console.warn('Miss Match', d.path, this.currentChapter.absolute),
  ...
  (EPUBJS.Book.prototype.isSaved = function (a) {
    var b;
    return !!localStorage && ((b = localStorage.getItem(a)), !(!localStorage || null === b));
  }),
  ...
  (EPUBJS.Book.prototype.renderTo = function (a) {
    ...
    return this.opened.then(function () {
      return (
        b.renderer.initialize(b.element, b.settings.width, b.settings.height),
        b.metadata.direction && b.renderer.setDirection(b.metadata.direction),
        b._rendered(),
        b.startDisplay()
      );
    });
  ...
  (EPUBJS.Book.prototype.displayChapter = function (a, b, c) {
    ...
    return this.isRendered
      ? this._rendering || this.renderer._moving
        ...
        : (EPUBJS.core.isNumber(a) ? (f = a) : ((e = new EPUBJS.EpubCFI(a)), (f = e.spinePos)),
          (f < 0 || f >= this.spine.length) && (console.warn('Not A Valid Location'), (f = 0), (b = !1), (e = !1)),
          (g = new EPUBJS.Chapter(this.spine[f], this.store)),
          (this._rendering = !0),
          this._needsAssetReplacement() &&
            g.registerHook('beforeChapterRender', [EPUBJS.replace.head, EPUBJS.replace.resources, EPUBJS.replace.posters, EPUBJS.replace.svg], !0),
          (h.currentChapter = g),
          ...
          i.promise)
      : (this._q.enqueue('displayChapter', arguments), i.reject({ message: 'Rendering', stack: new Error().stack }), i.promise);
  }),
  ...
  (EPUBJS.Book.prototype.gotoCfi = function (a, b) {
    ...
    return this.isRendered
      ? this._moving || this._rendering
        ? (console.warn('Renderer is moving'), this._gotoQ.enqueue('gotoCfi', [a, h]), !1)
        : ((c = new EPUBJS.EpubCFI(a)),
          (d = c.spinePos) != -1 &&
            ((e = this.spine[d]),
            (f = h.promise),
            (this._moving = !0),
            this.currentChapter && this.spinePos === d
              ? (this.renderer.gotoCfi(c), (this._moving = !1), h.resolve(this.renderer.currentLocationCfi))
              : ((e && d != -1) || ((d = 0), (e = this.spine[d])),
                (g = this.displayChapter(a)),
                g.then(
                  function (a) {
            ...
            f))
      : (console.warn('Not yet Rendered'), (this.settings.previousLocationCfi = a), !1);
  }),
    ...
    return this.isRendered
      ? this._moving || this._rendering
        ...
        : ((c = a.split('#')),
          (d = c[0]),
          (e = c[1] || !1),
          (f = d.search('://') == -1 ? d.replace(EPUBJS.core.uri(this.settings.contentsPath).path, '') : d.replace(this.settings.contentsPath, '')),
          ...
          'number' == typeof g &&
            (this.currentChapter && g == this.currentChapter.spinePos
              ? (e ? this.renderer.section(e) : this.renderer.firstPage(),
  ...
  (EPUBJS.Book.prototype.fromStorage = function (a) {
    ...
    this.contained ||
      this.settings.contained ||
      (this.online && this.opened.then(this.toStorage.bind(this)),
      this.store && this.settings.fromStorage && a === !1
        ? ((this.settings.fromStorage = !1), this.store.off('offline'), (this.store = !1))
        : this.settings.fromStorage ||
          ...
          this.store.on(
            ...
            function (a) {
              a
                ? ((this.offline = !0), (this.settings.fromStorage = !0), this.trigger('book:offline'))
                : ((this.offline = !1), (this.settings.fromStorage = !1), this.trigger('book:online'));
            }.bind(this),
          )));
  }),
  ...
  (EPUBJS.Book.prototype.addClass = function (a) {
    ...
    this.settings.classes.indexOf(a) == -1 && this.settings.classes.push(a),
  ...
  (EPUBJS.Book.prototype._registerReplacements = function (a) {
    a.registerHook('beforeChapterDisplay', this.applyStyles.bind(this, a), !0),
      ...
      a.registerHook('beforeChapterDisplay', this.applyClasses.bind(this, a), !0),
  ...
  (EPUBJS.Book.prototype.parseLayoutProperties = function (a) {
    return {
      layout: (this.settings.layoutOveride && this.settings.layoutOveride.layout) || a.layout || 'reflowable',
      spread: (this.settings.layoutOveride && this.settings.layoutOveride.spread) || a.spread || 'auto',
      orientation: (this.settings.layoutOveride && this.settings.layoutOveride.orientation) || a.orientation || 'auto',
    };
  }),
  ...
  (EPUBJS.Chapter.prototype.load = function (a, b) {
    ...
    return (
      (c = d ? d.getXml(this.absolute) : EPUBJS.core.request(this.absolute, !1, e)),
      c.then(
        function (a) {
          try {
    ...
    return this.load()
      .then(
        function (a) {
          ...
          return (
            c.setAttribute('href', this.absolute),
  ...
  (EPUBJS.Chapter.prototype.setDocument = function (a) {
    (this.document = a),
      (this.contents = a.documentElement),
  ...
  (EPUBJS.Chapter.prototype.cfiFromRange = function (a) {
    ...
    if (this.document) {
      if (void 0 !== document.evaluate) {
        if (
          ((c = EPUBJS.core.getElementXPath(a.startContainer)),
        ...
        e ||
          ...
          (g = EPUBJS.core.cleanStringForXpath(a.startContainer.textContent)),
          (c = '//text()[contains(.,' + g + ')]'),
          (e = this.document.evaluate(c, this.document, EPUBJS.core.nsResolver, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue) &&
            (b.setStart(e, a.startOffset),
            a.collapsed ||
              ((h = EPUBJS.core.cleanStringForXpath(a.endContainer.textContent)),
              (d = '//text()[contains(.,' + h + ')]'),
              (f = this.document.evaluate(d, this.document, EPUBJS.core.nsResolver, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue) &&
        ...
        for (var e, f, g, h = a.textContent.toLowerCase(), i = b.document.createRange(), j = -1, k = 150; f != -1; )
          (f = h.indexOf(d, j + 1)),
            f != -1 &&
              ...
              (e = b.cfiFromRange(i)),
              a.textContent.length < k ? (g = a.textContent) : ((g = a.textContent.substring(f - k / 2, f + k / 2)), (g = '...' + g + '...')),
              c.push({ cfi: e, excerpt: g })),
            (j = f);
      };
    return (
      this.textSprint(this.document, function (a) {
        e(a);
      }),
      c
    );
          ...
          var h = b.getAttribute(k),
            ...
            l = function (c) {
              ...
              (b.onload = function () {
                ...
                'svg image' == a && b.setAttribute('externalResourcesRequired', 'true'),
                'link[href]' == a && 'stylesheet' !== b.getAttribute('rel')
                  ? d(c, i)
                  : (e = setTimeout(function () {
                      d(c, i);
                    }, 5)),
                c && b.setAttribute(k, c);
            };
...
(EPUBJS.core.getEl = function (a) {
  ...
  (EPUBJS.core.request = function (a, b, c) {
          ...
          ((200 !== this.status && 0 !== this.status) || !this.response
            ...
            : ((a =
                'xml' == b
                  ? this.responseXML
                    ? this.responseXML
                    : new DOMParser().parseFromString(this.response, 'application/xml')
                  : 'xhtml' == b
                  ? this.responseXML
                    ? this.responseXML
                    : new DOMParser().parseFromString(this.response, 'application/xhtml+xml')
                  : 'html' == b
                  ? this.responseXML
                    ? this.responseXML
                    : new DOMParser().parseFromString(this.response, 'text/html')
                  : 'json' == b
    ...
    return (
      ...
      b || ((d = EPUBJS.core.uri(a)), (b = d.extension), (b = { htm: 'html' }[b] || b)),
      'blob' == b && (h.responseType = f),
      'json' == b && h.setRequestHeader('Accept', 'application/json'),
      'xml' == b && ((h.responseType = 'document'), h.overrideMimeType('text/xml')),
  ...
  (EPUBJS.core.uri = function (a) {
    ...
    return 0 === f
      ...
      : (i != -1 && ((e.fragment = a.slice(i + 1)), (a = a.slice(0, i))),
        h != -1 && ((e.search = a.slice(h + 1)), (a = a.slice(0, h)), (href = e.href)),
        g != -1
          ? ((e.protocol = a.slice(0, g)),
            (b = a.slice(g + 3)),
            (d = b.indexOf('/')),
            d === -1 ? ((e.host = e.path), (e.path = '')) : ((e.host = b.slice(0, d)), (e.path = b.slice(d))),
            (e.origin = e.protocol + '://' + e.host),
            (e.directory = EPUBJS.core.folder(e.path)),
            (e.base = e.origin + e.directory))
          : ((e.path = a), (e.directory = EPUBJS.core.folder(a)), (e.base = e.directory)),
  ...
  (EPUBJS.core.prefixed = function (a) {
    ...
    for (var e = 0; e < d; e++) if (void 0 !== document.documentElement.style[b[e] + c]) return b[e] + c;
    return a;
  }),
  ...
  (EPUBJS.core.getElementTreeXPath = function (a) {
    ...
    for (
      a.nodeType === Node.TEXT_NODE && ((b = EPUBJS.core.indexOfTextNode(a) + 1), f.push('text()[' + b + ']'), (a = a.parentNode));
      a && 1 == a.nodeType;
      a = a.parentNode
    ) {
      b = 0;
  ...
  (EPUBJS.core.indexOfNode = function (a, b) {
    for (var c, d = a.parentNode, e = d.childNodes, f = -1, g = 0; g < e.length && ((c = e[g]), c.nodeType === b && f++, c != a); g++);
    return f;
  }),
  (EPUBJS.core.indexOfTextNode = function (a) {
  ...
  (EPUBJS.EpubCFI.prototype.getCharecterOffsetComponent = EPUBJS.EpubCFI.prototype.getCharacterOffsetComponent =
    function (a) {
      return a.split(':')[1] || '';
    }),
  (EPUBJS.EpubCFI.prototype.parse = function (a) {
    var b,
      ...
      l = function (a) {
        var b, c, d, e;
        return (b = 'element'), (c = parseInt(a) / 2 - 1), (d = a.match(/\[(.*)\]/)), d && d[1] && (e = d[1]), { type: b, index: c, id: e || !1 };
      };
    return 'string' != typeof a
      ...
      : ((k.str = a),
        ...
        (e = this.getCharacterOffsetComponent(a)),
        c && (b = c.split('/')[2] || '')
          ? ((k.spinePos = parseInt(b) / 2 - 1 || 0),
            (g = b.match(/\[(.*)\]/)),
            (k.spineId = !!g && g[1]),
            ...
            (j = parseInt(i)),
            isNaN(j) || (j % 2 == 0 ? k.steps.push(l(i)) : k.steps.push({ type: 'text', index: (j - 1) / 2 })),
            (f = e.match(/\[(.*)\]/)),
            f && f[1] ? ((k.characterOffset = parseInt(e.split('[')[0])), (k.textLocationAssertion = f[1])) : (k.characterOffset = parseInt(e)),
            k)
          : { spinePos: -1 });
  }),
  (EPUBJS.EpubCFI.prototype.addMarker = function (a, b, c) {
    ...
    return (
      'string' == typeof a && (a = this.parse(a)),
      (e = a.steps[a.steps.length - 1]),
      a.spinePos !== -1 &&
        !!(d = this.findParent(a, h)) &&
        (e && 'text' === e.type
          ? ((f = d.childNodes[e.index]),
            a.characterOffset
              ? ((g = f.splitText(a.characterOffset)), i.classList.add('EPUBJS-CFI-SPLIT'), d.insertBefore(i, g))
              : d.insertBefore(i, f))
  ...
  (EPUBJS.EpubCFI.prototype.removeMarker = function (a, b) {
    ...
    a.classList.contains('EPUBJS-CFI-SPLIT')
      ? ((nextSib = a.nextSibling),
        (prevSib = a.previousSibling),
        nextSib &&
          prevSib &&
          3 === nextSib.nodeType &&
          3 === prevSib.nodeType &&
          ((prevSib.textContent += nextSib.textContent), a.parentNode.removeChild(nextSib)),
  ...
  (EPUBJS.EpubCFI.prototype.findParent = function (a, b) {
    ...
    for (; d && d.length > 0; ) {
      if (
        ((c = d.shift()),
        'text' === c.type ? ((e = g.childNodes[c.index]), (g = e.parentNode || g)) : (g = c.id ? f.getElementById(c.id) : h[c.index]),
        !g || void 0 === g)
      )
  ...
  (EPUBJS.EpubCFI.prototype.generateCfiFromTextNode = function (a, b, c) {
    var d = a.parentNode,
      e = this.pathTo(d);
    return (
      'epubcfi(' + c + '!/' + this.generatePathComponent(e) + '/' + (1 + 2 * Array.prototype.indexOf.call(d.childNodes, a)) + ':' + (b || 0) + ')'
    );
  }),
  ...
  (EPUBJS.EpubCFI.prototype.generateCfiFromRange = function (a, b) {
    ...
    return (
      ...
      a.collapsed
        ? 'epubcfi(' + b + '!/' + f + '/' + h + ':' + g + ')'
        : ((i = a.endContainer),
          3 === i.nodeType ? ((j = i.parentNode), (n = 1 + 2 * EPUBJS.core.indexOfTextNode(i)), (k = this.pathTo(j))) : (k = this.pathTo(i)),
  ...
  (EPUBJS.EpubCFI.prototype.generateRangeFromCfi = function (a, b) {
    ...
    return (
      'string' == typeof a && (a = this.parse(a)),
      a.spinePos !== -1 &&
        ((c = a.steps[a.steps.length - 1]),
        void 0 !== document.evaluate
          ? ((d = this.generateXpathFromSteps(a.steps)), (e = i.evaluate(d, i, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue))
          : ((g = this.generateQueryFromSteps(a.steps)), (h = i.querySelector(g)) && 'text' == c.type && (e = h.childNodes[c.index])),
        e
          ? (e && a.characterOffset >= 0
              ? ((f = e.length),
                a.characterOffset < f
                  ? (j.setStart(e, a.characterOffset), j.setEnd(e, f))
                  : (console.debug('offset greater than length:', a.characterOffset, f), j.setStart(e, f - 1), j.setEnd(e, f)))
              : e && j.selectNode(e),
            j)
          : null)
    );
  ...
  (EPUBJS.Events = function (a, b) {
    return (
      (this.events = {}),
      (this.el = b ? b : document.createElement('div')),
  ...
  (EPUBJS.Events.prototype.tell = function (a, b) {
    var c;
    this.events[a] ? (c = this.events[a]) : (console.warn('No event:', a, 'defined yet, creating.'), (c = this.createEvent(a))),
      b && (c.msg = b),
  ...
  (EPUBJS.Layout.Reflowable.prototype.format = function (a, b, c, d) {
    ...
    return (
      ...
      (this.colWidth = i),
      (this.gap = k),
      { pageWidth: this.spreadWidth, pageHeight: c }
    );
  }),
  ...
  (EPUBJS.Layout.Fixed.prototype.format = function (a, b, c, d) {
    ...
    (this.documentElement = a),
      l &&
        ...
        ((e = l.getAttribute('content')), (f = e.split(',')), f[0] && (g = f[0].replace('width=', '')), f[1] && (h = f[1].replace('height=', '')));
    var m = b / g,
      n = c / h,
      o = m < n ? m : n;
    return (
      ...
      (a.style.top = '50%'),
      (a.style.left = '50%'),
      (a.style[j] = 'scale(' + o + ') translate(-50%, -50%)'),
      (a.style[k] = '0px 0px 0px'),
      ...
      function (b) {
        ...
        this.sprint(
          ...
          function (b) {
            ...
            for (0 === h && ((c = f.createRange()), c.setStart(b, 0)), g = i - h, g > j && ((h += j), (k = j)); k < j; )
              (g = i - h),
                0 === h && ((k += 1), (c = f.createRange()), c.setStart(b, k)),
                k + g >= j ? ((h += j - k), (k = j)) : ((k += g), c.setEnd(b, k), (e = a.cfiFromRange(c)), this._locations.push(e), (h = 0));
            d = b;
          }.bind(this),
        ),
  ...
  (EPUBJS.Locations.prototype.setCurrent = function (a) {
    ...
    0 !== this._locations.length &&
      ('string' == typeof a ? ((b = this.locationFromCfi(a)), (this._current = b)) : (b = a),
      this.trigger('changed', { percentage: this.percentageFromLocation(b) }));
  }),
  ...
  (EPUBJS.Pagination.prototype.pageFromCfi = function (a) {
    ...
    return (
      c != -1
        ? (b = this.pages[c])
        : ((c = EPUBJS.core.locationOf(a, this.locations, this.epubcfi.compare)),
          void 0 !== (b = c - 1 >= 0 ? this.pages[c - 1] : this.pages[0]) || (b = -1)),
      b
    );
  }),
  ...
  (EPUBJS.Parser.prototype.container = function (a) {
    ...
    return a
      ? (b = a.querySelector('rootfile'))
        ? ((c = b.getAttribute('full-path')), (d = EPUBJS.core.uri(c).directory), (e = a.xmlEncoding), { packagePath: c, basePath: d, encoding: e })
  ...
  (EPUBJS.Parser.prototype.identifier = function (a) {
    var b;
    return a
      ? ((b = a.querySelector('metadata')), b ? this.getElementText(b, 'identifier') : void console.error('No Metadata Found'))
  ...
  (EPUBJS.Parser.prototype.findTocPath = function (a, b) {
    var c,
      d = a.querySelector("item[media-type='application/x-dtbncx+xml']");
    return d || ((c = b.getAttribute('toc')) && (d = a.querySelector("item[id='" + c + "']"))), !!d && d.getAttribute('href');
  }),
  (EPUBJS.Parser.prototype.metadata = function (a) {
    var b = {},
      c = this;
    return (
      (b.bookTitle = c.getElementText(a, 'title')),
  ...
  (EPUBJS.Parser.prototype.getElementText = function (a, b) {
    var c,
      d = a.getElementsByTagNameNS('http://purl.org/dc/elements/1.1/', b);
  ...
  (EPUBJS.Parser.prototype.querySelectorByType = function (a, b, c) {
    ...
    for (var e = 0; e < d.length; e++) if (d[e].getAttributeNS('http://www.idpf.org/2007/ops', 'type') === c) return d[e];
  }),
  ...
  (EPUBJS.Parser.prototype.tocItem = function (a, b, c) {
    var d,
      ...
      p = m ? m.cfi : '';
    return (
      o && 'navPoint' === o.nodeName && (d = o.getAttribute('id')),
      e || (l ? ((m = c[l]), (e = m.id), (p = m.cfi)) : ((e = 'epubjs-autogen-toc-id-' + EPUBJS.core.uuid()), a.setAttribute('id', e))),
      { id: e, href: g, label: i, spinePos: l, subitems: n, parent: d, cfi: p }
    );
  }),
  ...
  (EPUBJS.Render.Iframe.prototype.addIframe = function () {
    return (
      ...
      (this._width || this._height) && ((this.iframe.height = this._height), (this.iframe.width = this._width)),
      this.iframe
    );
  }),
  (EPUBJS.Render.Iframe.prototype.load = function (a, b) {
    ...
    return (
      ...
      this.document
        ? (this.iframe.contentDocument.open(), this.iframe.contentDocument.write(a), this.iframe.contentDocument.close(), d.promise)
  ...
  (EPUBJS.Render.Iframe.prototype.loaded = function (a) {
    var b,
      c,
      d = this.iframe.contentWindow.location.href;
    (this.document = this.iframe.contentDocument),
      ...
      this.window.focus(),
      'about:blank' != d && ((b = this.iframe.contentDocument.querySelector('base')), (c = b.getAttribute('href')), this.trigger('render:loaded', c));
  }),
  (EPUBJS.Render.Iframe.prototype.resize = function (a, b) {
    this.element &&
      ...
      this.iframe && ((this.iframe.height = b), (this.iframe.width = a)),
      (this._height = b),
      (this._width = a),
      (this.width = this.element.getBoundingClientRect().width || a),
      (this.height = this.element.getBoundingClientRect().height || b));
  }),
  ...
  (EPUBJS.Render.Iframe.prototype.setDirection = function (a) {
    (this.direction = a),
      this.docEl &&
        'rtl' == this.docEl.dir &&
        ((this.docEl.dir = 'rtl'), 'pre-paginated' !== this.layout && ((this.docEl.style.position = 'static'), (this.docEl.style.right = 'auto')));
  }),
  ...
  (EPUBJS.Render.Iframe.prototype.getPageNumberByElement = function (a) {
    var b;
    if (a) return (b = this.leftPos + a.getBoundingClientRect().left), Math.floor(b / this.pageWidth) + 1;
  }),
  ...
  (EPUBJS.Render.Iframe.prototype.isElementVisible = function (a) {
    ...
    return !!(
      ...
      ((b = a.getBoundingClientRect()), (c = b.left), 0 !== b.width && 0 !== b.height && c >= 0 && c < this.pageWidth)
    );
  }),
  ...
  (EPUBJS.Renderer = function (a, b) {
    (this.listenedEvents = ['keydown', 'keyup', 'keypressed', 'mouseup', 'mousedown', 'click']),
      ...
      'ontouchstart' in document.documentElement &&
        (this.listenedEvents.push('touchstart', 'touchend'), (this.upEvent = 'touchend'), (this.downEvent = 'touchstart')),
      a && void 0 !== EPUBJS.Render[a] ? (this.render = new EPUBJS.Render[a]()) : console.error('Not a Valid Rendering Method'),
      ...
      this.render.load(a, b).then(
        function (a) {
          EPUBJS.Layout.isFixedLayout(a) &&
            ...
            'rtl' == this.render.direction &&
              'rtl' != this.render.docEl.dir &&
              ((this.render.docEl.dir = 'rtl'),
              'pre-paginated' !== this.render.layout && ((this.render.docEl.style.position = 'absolute'), (this.render.docEl.style.right = '0'))),
            this.afterLoad(a),
            this.beforeDisplay(
              function () {
  ...
  (EPUBJS.Renderer.prototype.afterDisplay = function (a) {
    ...
    (this._moving = !1),
      ...
      0 === d &&
        (this.trigger('renderer:locationChanged', this.currentLocationCfi), this.trigger('renderer:visibleRangeChanged', this.visibleRangeCfi)),
      (c.cfi = this.currentLocationCfi),
      this.trigger('renderer:chapterDisplayed', c);
  }),
  ...
  (EPUBJS.Renderer.prototype.determineLayout = function (a) {
    var b = this.determineSpreads(this.minSpreadWidth),
      ...
      d = !1;
    return (
      'pre-paginated' === a.layout && ((c = 'Fixed'), (d = !0), (b = !1)),
      'reflowable' === a.layout && 'none' === a.spread && ((c = 'Reflowable'), (d = !1), (b = !1)),
      'reflowable' === a.layout && 'both' === a.spread && ((c = 'ReflowableSpreads'), (d = !1), (b = !0)),
      (this.spreads = b),
  ...
  (EPUBJS.Renderer.prototype.reformat = function () {
    var a,
      ...
      c = this;
    this.contents &&
      ((b = this.determineSpreads(this.minSpreadWidth)),
      b != this.spreads &&
        ((this.spreads = b), (this.layoutMethod = this.determineLayout(this.layoutSettings)), (this.layout = new EPUBJS.Layout[this.layoutMethod]())),
      (this.chapterPos = 1),
      this.render.page(this.chapterPos),
      (c.formated = c.layout.format(c.render.docEl, c.render.width, c.render.height, c.gap)),
      c.render.setPageDimensions(c.formated.pageWidth, c.formated.pageHeight),
      (a = c.layout.calculatePages()),
      c.updatePages(a),
  ...
  (EPUBJS.Renderer.prototype.page = function (a) {
    return this.pageMap
      ? a >= 1 &&
          ...
          !0)
      : (console.warn('pageMap not set, queuing'), this._q.enqueue('page', arguments), !0);
  }),
  ...
  (EPUBJS.Renderer.prototype.firstElementisTextNode = function (a) {
    var b = a.childNodes;
    return !!(b.length && b[0] && 3 === b[0].nodeType && b[0].textContent.trim().length);
  }),
  (EPUBJS.Renderer.prototype.isGoodNode = function (a) {
    return (
      ['audio', 'canvas', 'embed', 'iframe', 'img', 'math', 'object', 'svg', 'video'].indexOf(a.tagName.toLowerCase()) !== -1 ||
      this.firstElementisTextNode(a)
    );
  }),
  ...
  (EPUBJS.Renderer.prototype.containsPoint = function (a, b, c) {
    ...
    return !!(
      a &&
      'function' == typeof a.getBoundingClientRect &&
      ((d = a.getBoundingClientRect()), 0 !== d.width && 0 !== d.height && d.left >= b && b <= d.left + d.width)
    );
  }),
  (EPUBJS.Renderer.prototype.textSprint = function (a, b) {
    ...
    try {
      for (c = document.createTreeWalker(a, NodeFilter.SHOW_TEXT, { acceptNode: e }, !1); (d = c.nextNode()); ) b(d);
    } catch (f) {
  ...
  (EPUBJS.Renderer.prototype.mapPage = function () {
    var a,
      ...
      r = function (e) {
        var f;
        return (
          i.splitTextNodeIntoWordsRanges(e).forEach(function (e) {
            var g = e.getBoundingClientRect();
            !g ||
              (0 === g.width && 0 === g.height) ||
              (g.left + g.width < o
                ? j[l - 1] || (e.collapse(!0), (c = i.currentChapter.cfiFromRange(e)), (f = j.push({ start: c, end: null })))
                : (!a && d && ((b = i.splitTextNodeIntoWordsRanges(d)), (a = b[b.length - 1])),
                  a && j.length && (a.collapse(!1), (c = i.currentChapter.cfiFromRange(a)), j[j.length - 1] && (j[j.length - 1].end = c)),
                  e.collapse(!0),
                  (c = i.currentChapter.cfiFromRange(e)),
      ...
      t = s.dir;
    return (
      'rtl' == t && ((s.dir = 'ltr'), 'pre-paginated' !== this.layoutSettings.layout && (s.style.position = 'static')),
      this.textSprint(k, q),
      'rtl' == t && ((s.dir = t), 'pre-paginated' !== this.layoutSettings.layout && ((s.style.left = 'auto'), (s.style.right = '0'))),
      !a && d && ((b = i.splitTextNodeIntoWordsRanges(d)), (a = b[b.length - 1])),
      a && (a.collapse(!1), (c = i.currentChapter.cfiFromRange(a)), (j[j.length - 1].end = c)),
      j.length ||
        ((e = this.doc.createRange()),
        e.selectNodeContents(k),
        e.collapse(!0),
        (g = i.currentChapter.cfiFromRange(e)),
        (f = this.doc.createRange()),
        f.selectNodeContents(k),
        f.collapse(!1),
        (h = i.currentChapter.cfiFromRange(f)),
        j.push({ start: g, end: h })),
      (a = null),
      (b = void 0),
      (e = null),
      (f = null),
  ...
  (EPUBJS.Renderer.prototype.indexOfBreakableChar = function (a, b) {
    var c = '- \t\r\n\b\f';
    b || (b = 0);
    for (var d = b; d < a.length; d++) if (c.indexOf(a.charAt(d)) != -1) return d;
    return -1;
  }),
  (EPUBJS.Renderer.prototype.splitTextNodeIntoWordsRanges = function (a) {
    ...
    for (b = this.doc.createRange(), b.setStart(a, 0), b.setEnd(a, e), c.push(b), b = this.doc.createRange(), b.setStart(a, e + 1); e != -1; )
  ...
  (EPUBJS.Renderer.prototype.getRange = function (a, b, c) {
    ...
    return (
      (c = !0),
      void 0 === document.caretPositionFromPoint || c
        ? void 0 === document.caretRangeFromPoint || c
          ? ((this.visibileEl = this.findElementAfter(a, b)), e.setStart(this.visibileEl, 1))
          : (e = this.doc.caretRangeFromPoint(a, b))
        : ((d = this.doc.caretPositionFromPoint(a, b)), e.setStart(d.offsetNode, d.offset)),
      e
    );
  }),
  ...
  (EPUBJS.Renderer.prototype.getRenderedPagesLeft = function () {
    var a, b;
    return this.pageMap
      ? ((b = this.pageMap.length), (a = this.spreads ? 2 * this.chapterPos - 1 : this.chapterPos), b - a)
      : (console.warn('page map not loaded'), !1);
  }),
    ...
    return this.pageMap
      ? (this.spreads
          ? ((a = 2 * this.chapterPos),
            (b = this.pageMap[a - 2]),
            (c = b),
            this.pageMap.length > 1 && this.pageMap.length > a - 1 && (c = this.pageMap[a - 1]))
          : ((a = this.chapterPos), (b = this.pageMap[a - 1]), (c = b)),
        b || (console.warn('page range miss:', a, this.pageMap), (b = this.pageMap[this.pageMap.length - 1]), (c = b)),
  ...
  (EPUBJS.Renderer.prototype.gotoCfi = function (a) {
    ...
    if ((EPUBJS.core.isString(a) && (a = this.epubcfi.parse(a)), void 0 === document.evaluate))
      (c = this.epubcfi.addMarker(a, this.doc)) &&
        ((b = this.render.getPageNumberByElement(c)), this.epubcfi.removeMarker(c, this.doc), this.page(b));
...
(EPUBJS.replace = {}),
    ...
    var c = this,
      d = function (a, d) {
        ...
        k != -1
          ...
          : ((g = b.render.docEl.querySelector('base')),
            (i = g.getAttribute('href')),
            (h = EPUBJS.core.uri(i)),
            (e = h.directory),
            0 === j.indexOf('#') && (j = h.filename + j),
            (f = e ? ('file' === h.protocol ? EPUBJS.core.resolveUrl(h.base, j) : EPUBJS.core.resolveUrl(e, j)) : j),
            (a.onclick = function () {
        ...
        a.getText(b).then(
          function (d) {
            EPUBJS.replace.cssImports(a, b, d).then(
              function (e) {
                (d = e + d),
                  EPUBJS.replace.cssUrls(a, b, d).then(
                    function (a) {
  ...
  (EPUBJS.replace.cssImports = function (a, b, c) {
    ...
    if (a) {
      ...
      return (
        0 === g.length && d.resolve(h),
        g.forEach(function (c) {
          var e = EPUBJS.core.resolveUrl(b, c);
          (e = EPUBJS.core.uri(e).path),
            a.getText(e).then(
              function (a) {
  ...
  (EPUBJS.replace.cssUrls = function (a, b, c) {
    ...
    if (a) {
      ...
      var f = e.map(function (e) {
        var f = EPUBJS.core.resolveUrl(b, e.replace(/url\(|[|\)|\'|\"]|\?.*$/g, ''));
    ...
    return EPUBJS.core
      ...
      .catch(
        function () {
          ...
          return (
            this.offline || ((this.offline = !0), this.trigger('offline', !0)),
            d
              ? (d.then(function (b) {
