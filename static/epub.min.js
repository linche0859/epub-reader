...
!(function (a, b) {
  ...
  function w(a, b, c, d) {
    ...
    (a._onError = null),
      ...
      (e[f + Ca] = c),
      (e[f + Da] = d),
      0 === f && a._state && va.async(x, a);
  }
  function x(a) {
    var b = a._subscribers,
      c = a._state;
    if (
      (va.instrument && j(c === Ca ? "fulfilled" : "rejected", a),
      0 !== b.length)
    ) {
      for (
  ...
  function A(a, b, c, d) {
    ...
    if (e) {
      if (
        ((g = z(c, d)),
        g === Fa ? ((j = !0), (h = g.error), (g.error = null)) : (i = !0),
        b === g)
      )
        return void v(b, l());
    } else (g = d), (i = !0);
  ...
  function K(a, b) {
    (this._id = Ha++),
      ...
      m !== a &&
        ("function" != typeof a && I(), this instanceof K ? B(this, a) : J());
  }
  function L() {
    this.value = void 0;
  }
  ...
  function da(a, b, c) {
    return K.all(a, c).then(function (a) {
      ...
      for (var d = a.length, e = new Array(d), g = 0; g < d; g++)
        e[g] = b(a[g]);
      return K.all(e, c);
    });
  }
  ...
  Sa = Pa
    ...
    : Qa
    ? na()
    : void 0 === Ma && "function" == typeof require
    ? qa()
    : oa();
...
(EPUBJS.VERSION = "0.2.19"),
  ...
  (EPUBJS.Book = function (a) {
    (this.settings = EPUBJS.core.defaults(a || {}, {
      ...
      ("string" == typeof this.settings.bookPath ||
  ...
  (EPUBJS.Book.prototype.unpack = function (a) {
    ...
    (b.contents = c.packageContents(a, b.settings.contentsPath)),
      ...
      b.settings.bookKey ||
        (b.settings.bookKey = b.generateBookKey(b.metadata.identifier)),
      (b.globalLayoutProperties = b.parseLayoutProperties(b.metadata)),
      b.contents.coverPath &&
        (b.cover = b.contents.cover =
          b.settings.contentsPath + b.contents.coverPath),
                    ...
                    a.cfi ||
                      ...
                      c.generateCfiFromHref(a.href, b).then(function (c) {
                        (a.cfi = c),
                          ...
                          0 === (d -= 1) &&
                            (b.pagination.process(b.pageList),
      ...
      k = function (a) {
        ...
        if (g >= i) l.resolve();
          ...
          if (c && c.cancelled)
            return (
              e.remove(),
              this.element.removeChild(f),
              void l.reject(new Error("User cancelled"))
            );
          (h = g),
    ...
    return (
      this.ready.spine.promise.then(function () {
        d.generatePageList(a, b, c).then(
          function (a) {
            (d.pageList = d.contents.pageList = a),
              d.pagination.process(a),
              d.ready.pageList.resolve(d.pageList),
              e.resolve(d.pageList);
          },
          function (a) {
            e.reject(a);
          }
  ...
  (EPUBJS.Book.prototype.urlFrom = function (a) {
    ...
    return (
      ...
      c.protocol
        ...
        : d || e
        ? void 0
        : EPUBJS.core.resolveUrl(b || f.pathname, c.path)
    );
  }),
    ...
    return this.isRendered
      ? this._rendering || this.renderer._moving
        ...
        : (EPUBJS.core.isNumber(a)
            ? (f = a)
            : ((e = new EPUBJS.EpubCFI(a)), (f = e.spinePos)),
          (f < 0 || f >= this.spine.length) &&
            (console.warn("Not A Valid Location"), (f = 0), (b = !1), (e = !1)),
          ...
          d.then(
            function (a) {
              (h.spinePos = f),
                ...
                h.settings.fromStorage === !1 &&
                  h.settings.contained === !1 &&
                  h.preloadNextChapter(),
                (h._rendering = !1),
                h._displayQ.dequeue(),
      ...
      : (this._q.enqueue("displayChapter", arguments),
        i.reject({ message: "Rendering", stack: new Error().stack }),
        i.promise);
  }),
    ...
    return this.isRendered
      ? this._moving || this._rendering
        ? (console.warn("Renderer is moving"),
          this._gotoQ.enqueue("gotoCfi", [a, h]),
          !1)
        ...
        : ((c = a.split("#")),
          ...
          (f =
            d.search("://") == -1
              ...
              : d.replace(this.settings.contentsPath, "")),
  ...
  (EPUBJS.Book.prototype.removeClass = function (a) {
    ...
    b != -1 &&
      (delete this.settings.classes[b],
      this.renderer.setClasses(this.settings.classes),
      this.renderer.reformat());
  }),
  ...
  (EPUBJS.Book.prototype.parseLayoutProperties = function (a) {
    return {
      layout:
        (this.settings.layoutOveride && this.settings.layoutOveride.layout) ||
        a.layout ||
        "reflowable",
      spread:
        (this.settings.layoutOveride && this.settings.layoutOveride.spread) ||
        a.spread ||
        "auto",
      orientation:
        (this.settings.layoutOveride &&
  ...
  (EPUBJS.Chapter.prototype.load = function (a, b) {
    ...
    return (
      (c = d
        ...
        : EPUBJS.core.request(this.absolute, !1, e)),
      c.then(
        function (a) {
          try {
        ...
        for (
          ...
          (f = h.indexOf(d, j + 1)),
            f != -1 &&
              ...
              (e = b.cfiFromRange(i)),
              a.textContent.length < k
                ? (g = a.textContent)
                : ((g = a.textContent.substring(f - k / 2, f + k / 2)),
                  (g = "..." + g + "...")),
          ...
          var h = b.getAttribute(k),
            ...
            l = function (c) {
              ...
              (b.onload = function () {
                ...
                "svg image" == a &&
                  b.setAttribute("externalResourcesRequired", "true"),
...
(EPUBJS.core.getEl = function (a) {
  ...
  (EPUBJS.EpubCFI.prototype.getCharecterOffsetComponent =
    EPUBJS.EpubCFI.prototype.getCharacterOffsetComponent =
      function (a) {
        return a.split(":")[1] || "";
      }),
        ...
        c && (b = c.split("/")[2] || "")
          ? ((k.spinePos = parseInt(b) / 2 - 1 || 0),
            ...
            isNaN(j) ||
              (j % 2 == 0
                ? k.steps.push(l(i))
                : k.steps.push({ type: "text", index: (j - 1) / 2 })),
            (f = e.match(/\[(.*)\]/)),
            f && f[1]
              ? ((k.characterOffset = parseInt(e.split("[")[0])),
                (k.textLocationAssertion = f[1]))
              : (k.characterOffset = parseInt(e)),
            k)
          : { spinePos: -1 });
  }),
      ...
      a.spinePos !== -1 &&
        ...
        (e && "text" === e.type
          ? ((f = d.childNodes[e.index]),
            a.characterOffset
              ? ((g = f.splitText(a.characterOffset)),
  ...
  (EPUBJS.EpubCFI.prototype.createMarker = function (a) {
    ...
    return (
      (c.id = "EPUBJS-CFI-MARKER:" + EPUBJS.core.uuid()),
  ...
  (EPUBJS.EpubCFI.prototype.removeMarker = function (a, b) {
    ...
    a.classList.contains("EPUBJS-CFI-SPLIT")
      ...
      : a.classList.contains("EPUBJS-CFI-MARKER") &&
        a.parentNode.removeChild(a);
  }),
    ...
    for (; d && d.length > 0; ) {
      if (
        ...
        "text" === c.type
          ...
          : (g = c.id ? f.getElementById(c.id) : h[c.index]),
        !g || void 0 === g)
      )
  ...
  (EPUBJS.EpubCFI.prototype.compare = function (a, b) {
    if (
      ("string" == typeof a && (a = new EPUBJS.EpubCFI(a)),
    ...
    return (
      ...
      a.spinePos !== -1 &&
        ...
        void 0 !== document.evaluate
          ? ((d = this.generateXpathFromSteps(a.steps)),
            (e = i.evaluate(
              d,
              i,
              null,
          ...
          : ((g = this.generateQueryFromSteps(a.steps)),
            (h = i.querySelector(g)) &&
              "text" == c.type &&
              (e = h.childNodes[c.index])),
        e
  ...
  (EPUBJS.Events.prototype.tell = function (a, b) {
    ...
    this.events[a]
      ? (c = this.events[a])
      : (console.warn("No event:", a, "defined yet, creating."),
  ...
  (EPUBJS.Hooks = (function () {
    ...
    return (
      ...
      (a.prototype.removeHook = function (a, b) {
        ...
        void 0 !== this.hooks[a] &&
          ("function" == typeof b
            ...
            : Array.isArray(b) &&
              b.forEach(function (b) {
                (c = this.hooks[a].indexOf(b)) > -1 &&
                  this.hooks[a].splice(c, 1);
              }, this));
      }),
      ...
      }),
      {
        register: function (a) {
          if (
            (void 0 === EPUBJS.hooks[a] && (EPUBJS.hooks[a] = {}),
  ...
  (EPUBJS.Layout.ReflowableSpreads.prototype.calculatePages = function () {
    ...
    return (
      ...
      { displayedPages: b, pageCount: 2 * b }
    );
  }),
      ...
      function (b) {
        ...
        this.sprint(
          ...
          function (b) {
            ...
            for (
              0 === h && ((c = f.createRange()), c.setStart(b, 0)),
                g = i - h,
                g > j && ((h += j), (k = j));
              k < j;
    ...
    return a
      ? (b = a.querySelector("rootfile"))
        ? ((c = b.getAttribute("full-path")),
          ...
          (e = a.xmlEncoding),
          { packagePath: c, basePath: d, encoding: e })
  ...
  (EPUBJS.Parser.prototype.toc = function (a, b, c) {
    ...
    if (!g || 0 === h) return j;
    for (d = 0; d < h; ++d)
      (e = this.tocItem(g[d], b, c)),
        (i[e.id] = e),
        e.parent ? ((f = i[e.parent]), f.subitems.push(e)) : j.push(e);
    return j;
  }),
    ...
    return (
      ...
      e ||
        (l
          ...
          : ((e = "epubjs-autogen-toc-id-" + EPUBJS.core.uuid()),
            a.setAttribute("id", e))),
  ...
  (EPUBJS.Parser.prototype.pageListItem = function (a, b, c) {
    ...
    return k != -1
      ? ((d = h.split("#")),
        (e = d[0]),
        (f = d.length > 1 && d[1]),
        { cfi: f, href: h, packageUrl: e, page: j })
      : { href: h, page: j };
  }),
    ...
    return (
      ...
      this.document
        ? (this.iframe.contentDocument.open(),
          this.iframe.contentDocument.write(a),
  ...
  (EPUBJS.Render.Iframe.prototype.loaded = function (a) {
    ...
    (this.document = this.iframe.contentDocument),
      ...
      this.window.focus(),
      "about:blank" != d &&
        ((b = this.iframe.contentDocument.querySelector("base")),
  ...
  (EPUBJS.Render.Iframe.prototype.getPageNumberByElement = function (a) {
    ...
    if (a)
      return (
        (b = this.leftPos + a.getBoundingClientRect().left),
        Math.floor(b / this.pageWidth) + 1
      );
  }),
      ...
      a.render().then(
        function (c) {
          return (
            ...
            (this.layoutSettings = this.reconcileLayoutSettings(
              b,
              a.properties
            )),
            this.load(c, a.href)
        ...
        function (a) {
          EPUBJS.Layout.isFixedLayout(a) &&
            ...
            "rtl" == this.render.direction &&
              ...
              "pre-paginated" !== this.render.layout &&
  ...
  (EPUBJS.Renderer.prototype.afterLoad = function (a) {
    (this.contents = a),
      ...
      (this.formated = this.layout.format(
        a,
        this.render.width,
        this.render.height,
        this.gap
      ...
      this.initWidth ||
        this.initHeight ||
        this.render.window.addEventListener("resize", this.resized, !1),
  ...
  (EPUBJS.Renderer.prototype.determineLayout = function (a) {
    ...
    return (
      ...
      "reflowable" === a.layout &&
        "none" === a.spread &&
        ((c = "Reflowable"), (d = !1), (b = !1)),
      "reflowable" === a.layout &&
        "both" === a.spread &&
        ((c = "ReflowableSpreads"), (d = !1), (b = !0)),
      (this.spreads = b),
    ...
    for (var d, e, f, g, h = a, i = [h], j = 1e4, k = 0; !d && i.length; ) {
      ...
      if (
        (!d &&
          ...
          h &&
          null !== h.parentNode &&
          (i.push(h.parentNode), (g = h), (h = h.parentNode)),
        ++k > j)
      ) {
  ...
  (EPUBJS.Renderer.prototype.sprint = function (a, b) {
    for (
      var c,
        d = document.createTreeWalker(a, NodeFilter.SHOW_ELEMENT, null, !1);
      (c = d.nextNode());
  ...
  (EPUBJS.Renderer.prototype.mapPage = function () {
          ...
          i.splitTextNodeIntoWordsRanges(e).forEach(function (e) {
            ...
            !g ||
              ...
              (g.left + g.width < o
                ...
                : (!a &&
                    d &&
                    ((b = i.splitTextNodeIntoWordsRanges(d)),
                    (a = b[b.length - 1])),
                  a &&
                    j.length &&
                    (a.collapse(!1),
                    (c = i.currentChapter.cfiFromRange(a)),
                    j[j.length - 1] && (j[j.length - 1].end = c)),
                  e.collapse(!0),
                  (c = i.currentChapter.cfiFromRange(e)),
                  (f = j.push({ start: c, end: null })),
                  (l += 1),
    ...
    return (
      "rtl" == t &&
        ((s.dir = "ltr"),
        "pre-paginated" !== this.layoutSettings.layout &&
      ...
      !a &&
        d &&
        ((b = i.splitTextNodeIntoWordsRanges(d)), (a = b[b.length - 1])),
      a &&
        (a.collapse(!1),
        (c = i.currentChapter.cfiFromRange(a)),
        (j[j.length - 1].end = c)),
    ...
    return (
      ...
      void 0 === document.caretPositionFromPoint || c
        ? void 0 === document.caretRangeFromPoint || c
          ? ((this.visibileEl = this.findElementAfter(a, b)),
            e.setStart(this.visibileEl, 1))
          : (e = this.doc.caretRangeFromPoint(a, b))
        : ((d = this.doc.caretPositionFromPoint(a, b)),
  ...
  (EPUBJS.Renderer.prototype.getRenderedPagesLeft = function () {
    var a, b;
    return this.pageMap
      ? ((b = this.pageMap.length),
        (a = this.spreads ? 2 * this.chapterPos - 1 : this.chapterPos),
        b - a)
      : (console.warn("page map not loaded"), !1);
  }),
  (EPUBJS.Renderer.prototype.getVisibleRangeCfi = function () {
    ...
    return this.pageMap
      ? (this.spreads
        ...
        b ||
          (console.warn("page range miss:", a, this.pageMap),
  ...
  (EPUBJS.Renderer.prototype.gotoCfi = function (a) {
    ...
    if (
      (EPUBJS.core.isString(a) && (a = this.epubcfi.parse(a)),
      void 0 === document.evaluate)
    )
      (c = this.epubcfi.addMarker(a, this.doc)) &&
        ((b = this.render.getPageNumberByElement(c)),
  ...
  (EPUBJS.Storage.prototype.getText = function (a) {
    ...
    return EPUBJS.core
      ...
      .then(
        function (a) {
          return (
            this.offline && ((this.offline = !1), this.trigger("offline", !1)),
  ...
  (EPUBJS.Unarchiver.prototype.getXml = function (a, b) {
    ...
    return this.getText(c, b).then(function (b) {
      var c = new DOMParser(),
        d = EPUBJS.core.getMimeType(a);
      return (
        65279 === b.charCodeAt(0) && (b = b.slice(1)), c.parseFromString(b, d)
      );
    });
  }),
