...
document.addEventListener("mouseup", function (e) {
  ...
  if (
    ...
    sel.anchorNode.parentElement.className
      .split(" ")
      .some((className) => className.match(/hl-.*/gi))
  ) {
    selected(e);
...
function selected(e) {
  var x = e.clientX,
    ...
    menuHeight = window.parent.document.defaultView.getComputedStyle(
      menu,
      null
    ).height,
    menuWidth = window.parent.document.defaultView.getComputedStyle(
      menu,
      null
    ).width,
