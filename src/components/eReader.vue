  ...
  methods: {
    ...
    initBookEvent() {
      ...
      this.book.on('book:pageChanged', function (location) {
        console.log('book:pageChanged', location.anchorPage, location.pageRange);
      });
      ...
      this.book.on('renderer:mouseup', (event) => {
        ...
        console.log('selection.anchorNode.data.substring：', selection.anchorNode.data.substring(selection.baseOffset, selection.extentOffset));
        this.selectedText = selection.anchorNode.data.substring(selection.baseOffset, selection.extentOffset);
